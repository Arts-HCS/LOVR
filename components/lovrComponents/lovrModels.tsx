...
export default function LovrModels({
  ...
  return (
    ...
    >
      <div className="shrink-0 flex items-center justify-between px-8 pt-8 pb-5 border-b border-[#7d7d8140]">
        <div>
      ...
      <div className="flex-1 overflow-y-auto px-8 py-5 flex flex-col gap-y-3">
        ...
        {savedModels.map((model: any) => {
          ...
          return (
            <div
              key={model.modelID}
              className={`w-full flex items-center gap-4 px-5 py-3 rounded-md border transition-all duration-200 ${
                isActive
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[17px] font-semibold text-[#A87580] truncate">
                  {model.label}
                </p>
                <p className="text-[12px] text-[#7D7D81] mt-0.5">
                  {formatDate(model.createdAt)}
                </p>
              </div>

              <button 
                className={`w-13 h-8 rounded-xl hover:bg-[#7D7D81] flex items-center justify-center transition-all border border-[#7d7d8150] ${isActive ? "bg-[#baabb13e] pointer-events-none" :"bg-[#BAABB1]"}`}
              ...
              <div className="relative shrink-0" ref={isDescOpen ? modalRef : null}>
                <button
                  className="text-[13px] py-1.5 px-4 rounded-md bg-[#2d272d] border border-[#7d7d8150] hover:border-[#A87580] text-[#DCD9DE] transition-colors cursor-pointer"
                ...
                {isDescOpen && (
                  <div className="absolute right-0 top-full mt-2 z-50 w-72 rounded-md bg-[#2a2227] border border-[#A87580] shadow-xl p-4">
                    ...
                    <p className="text-[14px] text-[#DCD9DE] leading-relaxed">
              ...
              {isActive ? (
                <div className="shrink-0 h-8 w-8 rounded-full bg-[#A87580] flex items-center justify-center mx-3">
                  <i className="fa-solid fa-check text-[#DCD9DE] text-[13px]" />
                </div>
              ) : (
                <button
                  className="shrink-0 text-[13px] py-1.5 px-4 rounded-md bg-[#a87580ac] text-[#dcd9deac] border border-transparent hover:border-[#A87580] hover:text-[#DCD9DE] transition-all cursor-pointer"
      ...
      <div className="shrink-0 border-t border-[#7d7d8140] px-8 py-5">
        <button
          disabled={!!loading}
          onClick={() => setNombrar(!nombrar)}
          className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-md border text-[15px] text-(--white-color) transition-all duration-200 ${
            loading
        ...
        >
          <div className="flex items-center gap-3 px-1">
            <div className="flex items-center gap-1 flex-1">
              <span className="text-[16px] text-[#DCD9DE] font-medium whitespace-nowrap">
                {modelName}
              </span>
              <input
                className="w-full outline-none px-2 py-1 bg-transparent border-b border-[#A87580] text-[#b481a6] text-[16px] placeholder:text-[#7D7D81]"
                type="text"
            ...
            <button
              ...
              className={`text-[14px] py-1.5 px-5 rounded-md bg-[#A87580] text-(--white-color) transition-all duration-200 whitespace-nowrap ${
                nombreDeLaVersion === ""
