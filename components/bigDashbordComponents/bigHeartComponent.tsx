...
export default function BigHeartComponent({ activeUser }: { activeUser: any }) {
    ...
    <section className="bg-[#1c1d20] w-full h-full p-3 relative border-t border-[#A4767F] flex items-center justify-center">
      ...
      {!lovrCreated ? (
        ...
        <>
          ...
          <button className="fixed text-xl cursor-pointer transition hover:scale-90 h-30 w-70 rounded-2xl top-35 right-35 bg-[#202225ac] shadow-2xl border border-[#7D7D81]">Modelos</button>

          <button className="fixed text-xl cursor-pointer transition hover:scale-90 h-30 w-70 rounded-2xl bottom-30 left-60 bg-[#202225ac] shadow-2xl border border-[#7D7D81]">Entrenamiento</button>

          <button className="fixed text-xl cursor-pointer transition hover:scale-90 h-30 w-70 rounded-2xl bottom-40 right-50 bg-[#202225ac] shadow-2xl border border-[#7D7D81]">Uso</button>
        </>
      )}
    </section>
  );
